...
.EXAMPLE
    Install-Splunk -ComputerName Comp1,Comp2,Comp3 -Installer C:\Path\To\Installer.msi -SplunkUsername user -SplunkPass pass -DeploymentServer SplunkDeploy.domain.com:8089
#>
    [CmdletBinding()]
    param (
